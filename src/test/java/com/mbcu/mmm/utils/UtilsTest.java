...
public class UtilsTest {
	...
	public void signTest() {
		...
		Amount amount = new Amount(new BigDecimal("20"), Currency.fromString("JPY"),
	...
	public void testBlockingObs() {
		...
		pendingOrdersObs.subscribeOn(Schedulers.io()).subscribe(o -> {
	...
	public void testStreamFilter() {
		...
		List<String> res = lines.stream().filter(line -> "aaa".equals(line)).collect(Collectors.toList());
	...
	// assertEquals(s,
	// "0.0525506494749084/RJP/rB3gZey7VWHYRqJHLoHDEJXJ2pEPNieKiS");
	//
	// }
	//
	//
	...
	// Amount b = new Amount(Currency.fromString("JPY"),
	// AccountID.fromAddress("rB3gZey7VWHYRqJHLoHDEJXJ2pEPNieKiS"));
	// Amount bb = new Amount(Currency.fromString("JPY"),
	// AccountID.fromAddress("rB3gZey7VWHYRqJHLoHDEJXJ2pEPNieKiS"));
	// assertEquals(b, bb);
	// Amount c = new Amount(Currency.fromString("USD"),
	// AccountID.fromAddress("rB3gZey7VWHYRqJHLoHDEJXJ2pEPNieKiS"));
	// assertNotEquals(b, c);
	// Amount d= new Amount(new BigDecimal("0"));
	// assertNotEquals(b, d);
	// Amount e = new Amount(Currency.fromString("JPY"),
	// AccountID.fromAddress("rHMjZANhquizS74FutV3CNoWfQcoVkBxf"));
	// assertNotEquals(b, e);
	// }
	//
	// @Test
